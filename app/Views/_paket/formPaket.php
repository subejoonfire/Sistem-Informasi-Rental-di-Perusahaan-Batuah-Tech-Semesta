...
<div class="p-5 flex gap-2">
    <section class="w-1/2 bg-white rounded-box shadow-lg p-5">
        <form action="<?= base_url('paket/store'); ?>" method="POST" class="w-full" enctype="multipart/form-data">>
            <?= csrf_field(); ?>
            <div class="form-control mb-2">
                <label class="label">Nama Paket</label>
                <input name="nama_paket" type="text" placeholder="Nama Paket" class="input input-bordered" />
            </div>
            <div class="form-control mb-2">
                <label class="label">Deskripsi</label>
                <textarea id="editor" name="deskripsi_paket" class="textarea textarea-bordered" placeholder="Deskripsi"></textarea>
            </div>
            <div class="form-control mb-2">
                <label class="label">Harga Paket</label>
                <input name="harga_paket" type="text" placeholder="Harga Sewa" class="input input-bordered" />
            </div>
            <div class="form-control mb-2">
