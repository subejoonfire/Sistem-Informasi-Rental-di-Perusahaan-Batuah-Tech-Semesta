            ...
            <div class="flex h-full bg-white">
                ...
                <div id="Sidebar" class="hidden bg-white lg:block w-72 h-full overflow-auto no-scrollbar">
                    <ul class="menu  menu-lg w-full rounded-box drop-shadow-2xl">
                        ...
                        <li><a href="<?= base_url('dapur'); ?>" class="text-start <?= ($page == 'dapur') ? 'active' : ''; ?>"><i class="fa-solid fa-retweet w-10 text-center text-xl"></i>Dapur Busana</a></li>

                        <li></li>
                        <li class="text-center text-bold text-red-400">Promo</li>
                        <li><a href="<?= base_url('voucher'); ?>" class="text-start <?= ($page == 'voucher') ? 'active' : ''; ?>"><i class="fa-solid fa-ticket w-10 text-center text-xl"></i>Data Voucher</a></li>
                        <li></li>

                        <li class="text-center text-bold text-red-400">Costumer</li>
                        <li><a href="<?= base_url('pesanan'); ?>" class="text-start <?= ($page == 'pesanan') ? 'active' : ''; ?>"><i class="fa-solid fa-user-lock w-10 text-center text-xl"></i>Data Pesanan</a></li>
                        <li></li>
